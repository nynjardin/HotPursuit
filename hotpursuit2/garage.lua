...
--[[function PlayerIsAtStation(location)
	if ( GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), location1_x, location1_y, location1_z, true ) < 5 ) then return true end
	if ( GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), location2_x, location2_y, location2_z, true ) < 5 ) then return true end
	if ( GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), location3_x, location3_y, location3_z, true ) < 5 ) then return true end
	if ( GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), location4_x, location4_y, location4_z, true ) < 5 ) then return true end
	if ( GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), location5_x, location5_y, location5_z, true ) < 5 ) then return true end
	if ( GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), location6_x, location6_y, location6_z, true ) < 5 ) then return true end
end]]
